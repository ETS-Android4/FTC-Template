...
public class SHPMotor {
    ...
    public void enablePositionPID(double kP) {
        setUnit(unit);
        positionPID = new PositionPID(kP, getCurrentPosition());
    }

    public void enablePositionPID(double kP, double kI, double kD) {
        setUnit(unit);
        positionPID = new PositionPID(kP, kI, kD, getCurrentPosition());
    }
    ...
    public void setPower(double power) {
        if (voltageSensor != null) power *= (12.0 / voltageSensor.getVoltage());
    ...
    public void setVelocity(double velocity) {
        ...
        setPower(velocityPID.calculate(velocity));
    }
    ...
    public void setPosition(double position) {
        if (positionPID == null) return;
        positionPID.setCurrentPosition(getCurrentPosition());
        setPower(positionPID.calculate(position));
    }
